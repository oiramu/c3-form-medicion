...
export const placeholderData: FormData = {
  ...
  transformadoresTension: {
    faseR: { numeroSerie: '160057', modelo: 'VRS15', fabricante: 'HOWEST', burden: '25', cargasCompensacion: '8.15', frecuencia: '60', claseExactitud: '0.5', tensionPrimariaNominal: '13.8', tensionSecundariaNominal: '120', relacionTransformacion: '13800/120', corrienteTermica: '', corrienteDinamica: '', corrientePrimariaNominal: '', corrienteSecundariaNominal: '' },
    faseS: { numeroSerie: '160058', modelo: 'VRS15', fabricante: 'HOWEST', burden: '25', cargasCompensacion: '8.15', frecuencia: '60', claseExactitud: '0.5', tensionPrimariaNominal: '13.8', tensionSecundariaNominal: '120', relacionTransformacion: '13800/120', corrienteTermica: '', corrienteDinamica: '', corrientePrimariaNominal: '', corrienteSecundariaNominal: '' },
    faseT: { numeroSerie: '160059', modelo: 'VRS15', fabricante: 'HOWEST', burden: '25', cargasCompensacion: '8.15', frecuencia: '60', claseExactitud: '0.5', tensionPrimariaNominal: '13.8', tensionSecundariaNominal: '120', relacionTransformacion: '13800/120', corrienteTermica: '', corrienteDinamica: '', corrientePrimariaNominal: '', corrienteSecundariaNominal: '' },
  },
  conductores: {
    corriente: { calibre: '10', denominacion: 'AWG', longitud: '', numConductores: '6', tipo: 'multicond', material: 'Cobre', fabricante: 'CENTELSA' },
    tension: { calibre: '10', denominacion: 'AWG', longitud: '', numConductores: '3', tipo: 'multicond', material: 'Cobre', fabricante: 'CENTELSA' },
    errorCableado: '0.5',
  },
  comunicaciones: {
    principal: { numeroSerieModem: '', marcaModem: '', ip: '', puerto: '', apn: '', imei: '', commPortAddress: '', noTelefonico: '', operador: 'Movistar', medioComunicacion: 'Otra', otroMedio: 'RED INTERNA DE DATOS' },
    respaldo: { numeroSerieModem: '', marcaModem: '', ip: '', puerto: '', apn: '', imei: '', commPortAddress: '', noTelefonico: '', operador: 'Movistar', medioComunicacion: 'Otra', otroMedio: 'RED INTERNA DE DATOS' },
  },
